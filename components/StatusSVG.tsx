export default function VoiceSVG() {
  return (
    ...
    >
      ...
      <text x="223" y="129" fontSize="10" fill="#16a34a">Applied</text>
      ...
      <text x="221" y="154" fontSize="10" fill="#16a34a">Messaged</text>
      ...
      <text x="224" y="179" fontSize="10" fill="#dc2626">No Reply</text>
      ...
      <text x="221" y="204" fontSize="10" fill="#16a34a">Interview</text>
