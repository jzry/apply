    ...
    <nav className="fixed w-full z-50 transition-all duration-300 bg-white/80 backdrop-blur-md shadow-sm">
          ...
          <div className="bg-white rounded-3xl p-8">
            ...
            <div className="flex gap-2 mb-8 bg-gray-100 rounded-lg p-1">
              <button
                ...
                className={`cursor-pointer flex-1 py-2 px-4 rounded-md font-semibold transition-all ${
                  isLogin
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="cursor-pointer flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all font-semibold text-gray-700">
      ...
      <footer className="py-8 px-4 border-t border-gray-200">
        <div className="max-w-7xl mx-auto text-center text-gray-600 text-sm">
          <p>&copy; 2024 ApplyToJobs. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
